...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavView, @NonNull LinearLayout colorStrip,
      @NonNull FrameLayout navHostFragment) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.colorStrip;
      LinearLayout colorStrip = ViewBindings.findChildViewById(rootView, id);
      if (colorStrip == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, bottomNavView, colorStrip,
          navHostFragment);
    }
