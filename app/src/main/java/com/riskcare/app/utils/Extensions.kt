...
fun getStatusColor(context: Context, status: String?): Int {
    val colorRes = when (status?.lowercase()?.trim()) {
        "present", "approved", "confirmed", "paid"  -> com.riskcare.app.R.color.status_present
        "absent", "rejected"                         -> com.riskcare.app.R.color.status_absent
        "late"                                       -> com.riskcare.app.R.color.status_late
        "half-day", "half_day"                       -> com.riskcare.app.R.color.status_halfday
        "pending"                                    -> com.riskcare.app.R.color.status_pending
        "wfh"                                        -> com.riskcare.app.R.color.status_wfh
        "missing_punch_out"                          -> com.riskcare.app.R.color.status_late
        else                                         -> com.riskcare.app.R.color.text_secondary
    }
...
fun getStatusBgColor(context: Context, status: String?): Int {
    val colorRes = when (status?.lowercase()?.trim()) {
        "present", "approved", "confirmed", "paid"  -> com.riskcare.app.R.color.primary_ultra_light
        "absent", "rejected"                         -> com.riskcare.app.R.color.accent_red_light
        "late"                                       -> com.riskcare.app.R.color.accent_amber_light
        "half-day", "half_day"                       -> com.riskcare.app.R.color.accent_blue_light
        "pending"                                    -> com.riskcare.app.R.color.accent_orange_light
        "wfh"                                        -> com.riskcare.app.R.color.accent_purple_light
        "missing_punch_out"                          -> com.riskcare.app.R.color.accent_amber_light
        else                                         -> com.riskcare.app.R.color.background
    }
    return context.getColor(colorRes)
}
