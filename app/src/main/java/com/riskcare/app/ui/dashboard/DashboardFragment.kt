package com.riskcare.app.ui.dashboard
...
import com.riskcare.app.ui.chat.ChatFragment
import com.riskcare.app.ui.payroll.PayrollFragment
...
class DashboardFragment : Fragment() {
                            ...
                            postBtn.setOnClickListener {
                                ...
                                lifecycleScope.launch {
                                    try {
                                        ...
                                        val resp = RetrofitClient.instance.addAnnouncementComment(ann.id, com.riskcare.app.data.models.CommentRequest(textValue))
    ...
    private fun loadHeaderAvatar(emp: com.riskcare.app.data.models.Employee) {
        if (_b == null) return
