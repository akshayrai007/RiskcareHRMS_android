...
import com.riskcare.app.data.models.Employee
import com.riskcare.app.data.models.MovementPoint
...
class MovementFragment : Fragment(), OnMapReadyCallback {
    ...
    private fun refreshTrackingBanner() {
        val isTracking = com.riskcare.app.domain.usecase.TrackingManager(requireContext()).isTracking()
    ...
    private suspend fun fetchDirectionsSegment(
        ...
        try {
            val url = "https://maps.googleapis.com/maps/api/directions/json" +
                    ...
                    "&mode=driving" +
                    "&key=${AndroidMain.GOOGLE_MAPS_API_KEY}"
